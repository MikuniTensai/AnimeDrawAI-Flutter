...
class _SketchToImageScreenState extends State<SketchToImageScreen> {
  ...
  String _selectedSampler = "dpmpp_2m_sde";
  String _selectedScheduler = "karras";
  String _selectedCheckpoint =
      "wildcardxXLTURBO_wildcardxXLTURBOV10.safetensors";
  bool _isConfigExpanded = true;

  final List<String> _samplerOptions = [
    "euler",
    "euler_a",
    "heun",
    "dpm_2",
  ...
  final List<String> _schedulerOptions = [
    "normal",
    "karras",
    "exponential",
    "simple",
  ...
  Future<void> _processImage() async {
    ...
    try {
      ...
      final options = {
        ...
        "controlnet_strength": _controlnetStrength.toString(),
  ...
  void _showSuccessDialog(TaskStatusResponse result) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          "Your sketch has been transformed! Check your gallery for the result.",
        ),
        actions: [
          TextButton(
            onPressed: () {
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                "Turn Scrawls into Masterpieces",
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    decoration: InputDecoration(
                      labelText: "What should this sketch become?",
                      hintText: "e.g. A futuristic robot, oil painting...",
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                      ),
                    ),
                  ...
                  const SizedBox(height: 16),
                  _buildSliderColumn(
                    "Sketch Strength (ControlNet)",
                    _controlnetStrength,
                    0.0,
                    2.0,
                    (v) => setState(() => _controlnetStrength = v),
                    isFloat: true,
                  ),
                  _buildSliderColumn(
                    "Denoise (Imagination)",
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButton<String>(
                              isExpanded: true,
                              value: _selectedScheduler,
                              items: _schedulerOptions
                                  .map(
                                    (s) => DropdownMenuItem(
                                      value: s,
                                      child: Text(
